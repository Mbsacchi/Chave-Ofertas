export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    // If live API returned no items or token is pending, provide curated Awin Network Partner Deals
      ...
      rawAwinOffers = [
        {
          ...
          trackingUrl: `https://www.awin1.com/cread.php?awinmid=17621&awinaffid=${publisherId}&clickref=site&p=https%3A%2F%2Fwww.casasbahia.com.br`,
          freeShipping: true,
        ...
        },
        {
          ...
          trackingUrl: `https://www.awin1.com/cread.php?awinmid=17622&awinaffid=${publisherId}&clickref=site&p=https%3A%2F%2Fwww.pontofrio.com.br`,
          freeShipping: true,
        ...
        },
        {
          ...
          trackingUrl: `https://www.awin1.com/cread.php?awinmid=17623&awinaffid=${publisherId}&clickref=site&p=https%3A%2F%2Fwww.extra.com.br`,
          freeShipping: true,
        ...
        },
        {
          ...
          trackingUrl: `https://www.awin1.com/cread.php?awinmid=18879&awinaffid=${publisherId}&clickref=site&p=https%3A%2F%2Fbest.aliexpress.com`,
          freeShipping: true,
        ...
        },
        {
          ...
          trackingUrl: `https://www.awin1.com/cread.php?awinmid=18105&awinaffid=${publisherId}&clickref=site&p=https%3A%2F%2Fwww.centauro.com.br`,
          freeShipping: true,
    ...
    const mappedProducts = rawAwinOffers.map((item: any, index: number) => {
      ...
      const affiliateUrl = item.trackingUrl || item.url || item.clickThroughUrl || `https://www.awin1.com/cread.php?awinaffid=${publisherId}`;
      const imageUrl = item.imageUrl || item.image || item.logoUrl || 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&auto=format&fit=crop&q=80';
      const categoryName = item.category || 'Geral';
      const brand = item.brand || storeName;

      const offer = {
        id: `awin-offer-${Date.now()}-${index}`,
        storeId: 'awin' as any,
        storeName,
